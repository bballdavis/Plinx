...
enum PlinxMediaDetailActionTreatment {
    case primary
    case secondary
}

struct PlinxMediaDetailActionStyle: ButtonStyle {
    let treatment: PlinxMediaDetailActionTreatment
    let secondarySideLength: CGFloat

    init(
        treatment: PlinxMediaDetailActionTreatment,
